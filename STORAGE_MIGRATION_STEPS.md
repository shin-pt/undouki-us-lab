# Firebase Storage 画像データ移行ステップ

## 🎯 目標

`echo-quiz-app`プロジェクトのStorageから`musculoskeletal-us-lab`プロジェクトのStorageへ画像データを移行し、コードを変更して統合後のStorage Bucketを使用するように設定します。
...
```dart:echo-quiz-app/lib/firebase_options.dart
  static const FirebaseOptions web = FirebaseOptions(
    ...
    storageBucket: 'musculoskeletal-us-lab.firebasestorage.app', // 変更: 統合後のStorage Bucket
  );
